...
<div class="destinations-list-slider slick-initialized slick-slider">
<div aria-live="polite" class="slick-list draggable">
<div class="slick-track" role="listbox" style={{opacity: "1", width: "2570px", left: "-771px"}}>
<div class="d-list-slider-item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide11" style={{width: "257px"}} data-slick-index="-3" aria-hidden="true"><div class="single-destinations-list text-center">
<div class="thumb">
<img src="images/gallary/s2.png" alt="list"/>
<div class="d-list-btn-wrap">
<div class="d-list-btn viaje-go-top">
<a class="btn btn-yellow" href="#/contact" tabindex="-1">Book Now <i class="fa fa-paper-plane"></i></a>
</div>
</div>
</div>
<div class="details">
...
<div class="d-list-slider-item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide12" style={{width: "257px"}} data-slick-index="-2" aria-hidden="true">
<div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s3.png" alt="list"/>
<div class="d-list-btn-wrap">
<div class="d-list-btn viaje-go-top">
<a class="btn btn-yellow" href="#/contact" tabindex="-1">Book Now <i class="fa fa-paper-plane"></i></a>
</div>
...
<div class="d-list-slider-item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide13" style={{width: "257px"}} data-slick-index="-1" aria-hidden="true">
<div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s1.png" alt="list"/>
<div class="d-list-btn-wrap">
<div class="d-list-btn viaje-go-top">
<a class="btn btn-yellow" href="#/contact" tabindex="-1">Book Now <i class="fa fa-paper-plane"></i></a>
</div>
...
<div class="d-list-slider-item slick-slide slick-current slick-active" tabindex="-1" role="option" aria-describedby="slick-slide10" style={{width: "257px"}} data-slick-index="0" aria-hidden="false"><div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s1.png" alt="list"/>
<div class="d-list-btn-wrap">
<div class="d-list-btn viaje-go-top">
<a class="btn btn-yellow" href="#/contact" tabindex="0">Book Now <i class="fa fa-paper-plane"></i></a>
</div>
</div>
</div>
<div class="details">
...
<div class="d-list-slider-item slick-slide slick-active" tabindex="-1" role="option" aria-describedby="slick-slide11" style={{width: "257px"}} data-slick-index="1" aria-hidden="false"><div class="single-destinations-list text-center">
<div class="thumb">
<img src="images/gallary/s2.png" alt="list"/>
<div class="d-list-btn-wrap">
<div class="d-list-btn viaje-go-top">
...
<div class="d-list-slider-item slick-slide slick-active" tabindex="-1" role="option" aria-describedby="slick-slide12" style={{width: "257px"}} data-slick-index="2" aria-hidden="false">
<div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s3.png" alt="list"/>
<div class="d-list-btn-wrap"><div class="d-list-btn viaje-go-top">
<a class="btn btn-yellow" href="#/contact" tabindex="0">Book Now <i class="fa fa-paper-plane"></i></a>
</div>
</div>
</div>
...
<div class="d-list-slider-item slick-slide" tabindex="-1" role="option" aria-describedby="slick-slide13" style={{width: "257px"}} data-slick-index="3" aria-hidden="true">
<div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s1.png" alt="list"/>
...
<div class="tp-price-meta tp-price-meta-cl">
<p>Price</p><h2>620 <small>$</small>
</h2><del>620<span>$</span></del>
</div>
</div>
</div>
</div>
<div class="d-list-slider-item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide10" style={{width: "257px"}} data-slick-index="4" aria-hidden="true">
<div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s1.png" alt="list"/>
...
<div class="d-list-slider-item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide11" style={{width: "257px"}} data-slick-index="5" aria-hidden="true"><div class="single-destinations-list text-center">
<div class="thumb">
<img src="images/gallary/s2.png" alt="list"/>
<div class="d-list-btn-wrap">
<div class="d-list-btn viaje-go-top">
...
<div class="d-list-slider-item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide12" style={{width: "257px"}} data-slick-index="6" aria-hidden="true"><div class="single-destinations-list text-center">
<div class="thumb">
<span class="d-list-tag">Special Offer</span>
<img src="images/gallary/s3.png" alt="list"/>
<div class="d-list-btn-wrap">
...
<div class="tp-price-meta tp-price-meta-cl">
<p>Price</p><h2>620 <small>$</small></h2>
<del>620<span>$</span></del>
</div>
</div>
</div>
...
<div class="slider-nav tp-control-nav">
<span class="slick-prev slick-arrow" style={{display: "block"}}><i class="la la-long-arrow-left"></i></span>
<span class="slick-next slick-arrow" style={{display: "block"}}><i class="la la-long-arrow-right"></i></span>
</div>
...
<div class="d-list-progress" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style={{backgroundSize: "0% 100%"}}>
<span class="slider__label sr-only">0% completed</span>
	...
	<div className="video-area tp-video-area pd-top-60" style={{backgroundImage: "url(images/gallary/img1.png)"}}>
	<div className="container viaje-go-top">
	<div className="row">
	<div className="col-xl-5 col-lg-6 align-self-center wow  fadeInRight animated" data-wow-duration="1s" data-wow-delay="0.3s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.3s", animationName: "fadeInRight"}}>
	<div className="section-title-y mb-lg-0 mb-4 text-center text-lg-left">
	<h2 className="title-y">What Do You Know <br/> About US</h2>
	...
	<a className="btn btn-yellow-y" href="#/about"><span>Read More<i className="la la-arrow-right"></i></span></a>
	</div>
	</div>
	<div className="col-xl-5 col-lg-6 offset-xl-1 wow  fadeInLeft animated" data-wow-duration="1s" data-wow-delay="0.3s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.3s", animationName: "fadeInLeft"}}>
	<div className="video-popup-wrap">
	<div className="thumb">
	<img src="/images/gallary/video.png" alt="video"/>
	</div>
	<div className="video-popup-btn">
	<a href="https://www.youtube.com/watch?v=c7XEhXZ_rsk" className="video-play-btn mfp-iframe"><i className="fa fa-play"></i></a>
	</div>
	</div>
	</div>
	</div>
...
<div className="holiday-plan-area tp-holiday-plan-area mg-top-96" style={{backgroundImage: "url(images/gallary/img2.png)"}}>
<div className="container">
<div className="row justify-content-center">
<div className="col-xl-6 col-lg-9">
<div className="section-title-y text-center">
<h2 className="title-y wow  fadeInUp animated" data-wow-duration="0.6s" data-wow-delay="0.1s" style={{visibility: "visible", animationDuration: "0.6s", animationDelay: "0.1s", animationName: "fadeInUp"}}>Perfect Holiday Plan</h2>
<p className="wow  fadeInUp animated" data-wow-duration="0.6s" data-wow-delay="0.2s" style={{visibility: "visible", animationDuration: "0.6s", animationDelay: "0.2s", animationName: "fadeInUp"}}>No vis fastidii accumsan, ignota postulant ea mea. Vis et prima integre, ei vis ridens moderatius reformidans cu vim doctus accumsan ignota.</p>
</div>
</div>
</div>
<div className="row">
<div className="col-lg-3 col-sm-6">
<div className="single-destinations-list style-two wow  fadeInUp animated" data-wow-duration="0.4s" data-wow-delay="0.1s" style={{visibility: "visible", animationDuration: "0.4s", animationDelay: "0.1s", animationName: "fadeInUp"}}>
<div className="thumb">
...
<div className="col-lg-3 col-sm-6">
<div className="single-destinations-list style-two wow  fadeInUp animated" data-wow-duration="0.7s" data-wow-delay="0.2s" style={{visibility: "visible", animationDuration: "0.7s", animationDelay: "0.2s", animationName: "fadeInUp"}}>
<div className="thumb">
...
<div className="col-lg-3 col-sm-6">
<div className="single-destinations-list style-two wow  fadeInUp animated" data-wow-duration="0.9s" data-wow-delay="0.3s" style={{visibility: "visible", animationDuration: "0.9s", animationDelay: "0.3s", animationName: "fadeInUp"}}>
<div className="thumb">
...
<div className="col-lg-3 col-sm-6">
<div className="single-destinations-list style-two wow  fadeInUp animated" data-wow-duration="1.1s" data-wow-delay="0.4s" style={{visibility: "visible", animationDuration: "1.1s", animationDelay: "0.4s", animationName: "fadeInUp"}}>
<div className="thumb">
...
{/* <!--galley start--> */}
		...
		<div className="thumb wow  fadeInRight   animated" data-wow-duration="1s" data-wow-delay="0.3s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.3s", animationName: "fadeInRight"}}>
		...
		<img src="images/gallary/russia.png" alt="russia"/>
			...
			<div className="single-client-review wow  fadeInLeft   animated" data-wow-duration="1s" data-wow-delay="0.3s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.3s"}}>
...
<a class="tag" href="#/blog-details">Europe</a>
